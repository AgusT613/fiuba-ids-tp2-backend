...
## Seed de datos y ejecución del servidor

Al ejecutar el comando `pipenv run fastapi dev main.py`, en caso de no existir la base de datos, ejecuta las migraciones de `alembic` y realiza el seed de datos automaticamente.
